...
if window then
	...
	check(sliders == 8,
		("%d sliders in the panel, expected the UI size, the debuff icon, five"
			.. " backgrounds (the meters, the chat window, one per feed and the"
			.. " bar the buttons page is showing) and that bar's square")
			:format(sliders))
