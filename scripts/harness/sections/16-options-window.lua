...
if window then
	...
	-- takes it to 19,368 across fifty-seven. 19,500 is that measurement plus a
	-- hint's worth of room, checked on the warrior run, which is the class with
	-- the most sections.
	check(prose < 19500,
		("the window holds %d characters of prose and the budget is 19,500"):format(prose))
