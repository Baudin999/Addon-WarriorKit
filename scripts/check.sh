...
sections/52-character.lua:858:one subject, the character sheet window; the gear page is already a file of its own, and what is left is the sheet's key, its secure drag and its tabs, which are one window's chrome and move together
