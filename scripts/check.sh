...
client/02-text.lua:803:one class, the Region stub; every line is a method of the client's own frame, and a frame API split across two files is two halves of one object
